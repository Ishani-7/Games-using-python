...
while True:
    ...
    if (
        (choice1 == "Rock" and choice2 == "Paper")
        or (choice1 == "Paper" and choice2 == "Scissors")
        or (choice1 == "Scissors" and choice2 == "Rock")
    ):
        print("Player two wins")
        break
    if (
        (choice2 == "Rock" and choice1 == "Paper")
        or (choice2 == "Paper" and choice1 == "Scissors")
        or (choice2 == "Scissors" and choice1 == "Rock")
    ):
